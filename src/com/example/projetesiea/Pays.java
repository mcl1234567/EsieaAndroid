...
public class Pays {
	...
	public Pays(String nom, String monnaie, String population, String formeEtat, String roi,  String presidentGouv, String langue, String capitale, 
			...
			String pib, String nombreExpatries, String tauxChomage, String indicatifTel) 
	{
		this.nom = nom;
	...
	public String getPremierGouvernement() { return this.presidentGouvernement; }
